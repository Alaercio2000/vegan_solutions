...
<body>
  ...
  <div class="banner">
    <img class="bannerImg" src="assets/img/banner.jpg" />
    <div class="container">
      <div class="row">
      ...
      <div class="row mt-5">
        ...
        <main class="col-12 col-sm-9">
          <div class="row ml-3">
            <div class="col-12 col-md-5">
              <div class="card-body d-flex flex-column">
                <img class="restaurante" src="assets/img/restaurante_1.png" />
              </div>
            </div>
          ...
          <div class="row border-top ml-3">
            <div class="col-12 col-md-5">
              <div class="card-body d-flex flex-column">
                <img class="restaurante" src="assets/img/restaurante_2.jpg" />
              </div>
            </div>
            <div class="col-12 col-md-7">
              <div class="row">
          ...
          <div class="row border-top ml-3">
            <div class="col-12 col-md-5">
              <div class="card-body d-flex flex-column">
                <img class="restaurante" src="assets/img/restaurante_3.png" />
              </div>
            </div>
            <div class="col-12 col-md-7">
              <div class="row">
