...
<body>
    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
        ...
        <a target="_blank"
            href="https://www.revistalofficiel.com.br/moda/5-marcas-brasileiras-sustentaveis-para-voce-ficar-de-olho-em-2019">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/img/reciclagem.jpg" href="http://google.com" alt="Primeiro Slide">
    ...
    <a target="_blank" href="http://dnanatural.com.br/6-dicas-para-comecar-uma-dieta-vegetariana-ou-vegana/">
        <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/organicos.jpg" alt="Segundo Slide">
            <div class="carousel-caption d-none d-md-block">
    ...
    <a target="_blank" href="http://www.belagil.com/blog/2016/8/2/a-alimentao-viva-ou-crudivorismo">
        <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/crudi.jpg" alt="Terceiro Slide">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="row">
            ...
            <div class="container mt-5">
                <div class="row">
                    ...
                    <div class="container mt-5"> <?php require("../footer/footer.php"); ?></div>
